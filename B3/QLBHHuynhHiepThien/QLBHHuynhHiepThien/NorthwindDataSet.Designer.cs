...
namespace QLBHHuynhHiepThien {
    ...
    public partial class NorthwindDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeesRow AddEmployeesRow(string LastName, string FirstName, string Title, string TitleOfCourtesy, System.DateTime BirthDate, System.DateTime HireDate, string Address, string City, string Region, string PostalCode, string Country, string HomePhone, string Extension, string Photo, string Notes) {
...
namespace QLBHHuynhHiepThien.NorthwindDataSetTableAdapters {
...
SELECT CategoryID, CategoryName, Description, Picture FROM Categories WHERE (CategoryID = @CategoryID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::QLBHHuynhHiepThien.Properties.Settings.Default.NorthwindConnectionString;
        }
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle, Address, City, Region, PostalCode, Country, Phone, Fax FROM Customers WHERE (CustomerID = @CustomerID)";
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Employees] ([LastName], [FirstName], [Title], [TitleOfCourtesy], [BirthDate], [HireDate], [Address], [City], [Region], [PostalCode], [Country], [HomePhone], [Extension], [Photo], [Notes]) VALUES (@LastName, @FirstName, @Title, @TitleOfCourtesy, @BirthDate, @HireDate, @Address, @City, @Region, @PostalCode, @Country, @HomePhone, @Extension, @Photo, @Notes);
SELECT EmployeeID, LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [T" +
                ...
                "xtension] = @Extension, [Photo] = @Photo, [Notes] = @Notes WHERE (([EmployeeID] " +
                ...
                "ULL) OR ([Extension] = @Original_Extension)) AND ((@IsNull_Photo = 1 AND [Photo]" +
                " IS NULL) OR ([Photo] = @Original_Photo)));\r\nSELECT EmployeeID, LastName, FirstN" +
                "ame, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalC" +
                "ode, Country, HomePhone, Extension, Photo, Notes FROM Employees WHERE (EmployeeI" +
                "D = @EmployeeID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        public virtual int Update(
            ...
            if ((Original_TitleOfCourtesy == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[21].Value = ((string)(Original_TitleOfCourtesy));
            }
            if ((Original_BirthDate.HasValue == true)) {
            ...
            if ((Original_Extension == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[39].Value = ((string)(Original_Extension));
            }
            if ((Original_Photo == null)) {
        ...
        public virtual int Update(
                    ...
                    string Original_Extension, 
                    string Original_Photo) {
            return this.Update(LastName, FirstName, Title, TitleOfCourtesy, BirthDate, HireDate, Address, City, Region, PostalCode, Country, HomePhone, Extension, Photo, Notes, Original_EmployeeID, Original_LastName, Original_FirstName, Original_Title, Original_TitleOfCourtesy, Original_BirthDate, Original_HireDate, Original_Address, Original_City, Original_Region, Original_PostalCode, Original_Country, Original_HomePhone, Original_Extension, Original_Photo, Original_EmployeeID);
        }
    }
